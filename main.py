...
# Mongo ENV
MONGO_URL = os.getenv("MONGO_URL") or "mongodb+srv://milanosherzodgold_db_user:Sherzod777@cluster0.ftuoneb.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
